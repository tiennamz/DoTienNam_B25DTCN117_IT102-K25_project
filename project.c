...
void returnBorrow() {
    ...
    for (int i = 0; i < n_borrow; i++) {
        if (listBorrow[i].bookId == returnBookId && listBorrow[i].status == 1) {
            borrowIndex = i;
            found = 1;
            break;
        }
